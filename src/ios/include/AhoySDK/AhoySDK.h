...
- (void)callAddress:(NSString *)address metaData:(NSDictionary *)metaData presentingViewController:(UIViewController *)viewController callback:(void(^)(BOOL, NSDictionary *))callback;
- (void)callContact:(NSDictionary *)contact callback:(void(^)(BOOL, NSDictionary *))callback;
